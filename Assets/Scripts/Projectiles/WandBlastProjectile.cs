...
public class WandBlastProjectile : Projectile {
...
//	public  Vector3 projectileSpawnPositionOffset = new Vector3(0.75f,0,0);		<--- durch vererbung enthalten
	...
	public WandBlastProjectile(string resFolder, string prefabFilename, Vector3 spawnOffset) : base(resFolder, prefabFilename, spawnOffset)
	{
	}
